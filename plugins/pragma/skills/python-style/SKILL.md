...
- Note: bare `except:` and broad `except Exception:` completeness checks are owned by the error-handling validator. This validator owns chaining style and exception hierarchy.
