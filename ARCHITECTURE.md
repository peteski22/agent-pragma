...
- **OpenCode:** Auto-loads `AGENTS.md` at the project root, which imports `.claude/rules/*.md` via `@` directives. `/setup-project` manages this via a `<!-- pragma:start -->` / `<!-- pragma:end -->` block.
